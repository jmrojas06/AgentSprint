...
Un vídeo de 45 segundos que muestra el flujo completo: desde `npx @jmrojas06/agentsprint-cli init` hasta que un agente reclama una tarea y la mueve a Review. El storyboard y el guion viven en el repositorio (`docs/video-storyboard.md` y `docs/video-script-es.md`).
...
- Publica el resultado en GitHub y enlázalo desde el README.
